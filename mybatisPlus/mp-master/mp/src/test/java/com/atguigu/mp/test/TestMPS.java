...
public class TestMPS {
	...
	public void testGenerator() throws SQLException, ClassNotFoundException {
		...
		String commonPath="E:\\idea\\workspace11\\";
		...
		String authName="yegang";
		String serviceName= "%sManager";
		String serviceNameImpl= "%sManagerImpl";
		String baseTemplatesDir="/templatesMybatis/";
		String XMLControllerDir =baseTemplatesDir+"controller.java.vm";
		String XMLServiceDir =baseTemplatesDir+"service.java.vm";
		String XMLServiceImplDir =baseTemplatesDir+"serviceImpl.java.vm";
		String XMLEntityDir =baseTemplatesDir+"entity.java.vm";
		String XMLMapperDir =baseTemplatesDir+"mapper.java.vm";
		String XMLMapperXMLDir =baseTemplatesDir+"mapper.xml.vm";
		String XMLViewPageDir =baseTemplatesDir+"view.html.vm";
		String XMLEditPageDir =baseTemplatesDir+"edit.html.vm";
		String XMLFilterDir =baseTemplatesDir+"filter.java.vm";
		List<String> list = new ArrayList<String>();
		//不需要生成代码的表
		String [] exit_tables={"SYS_USER"};
		String driver = "com.mysql.jdbc.Driver";
		String url = "jdbc:mysql://localhost:3306/gis";
		String user = "root";
