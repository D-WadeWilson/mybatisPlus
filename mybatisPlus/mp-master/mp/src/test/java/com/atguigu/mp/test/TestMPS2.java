...
public class TestMPS2 {
	 ...
	 */
	@Test
	public void testGenerator() throws SQLException, ClassNotFoundException, IOException {
    	...
    	InputStreamReader isr = new InputStreamReader(fis, "utf-8");//将文件编码指定为utf-8 解决中文乱码问题
        p.load(isr);
		...
		//不需要生成代码的表
		String [] exit_tables=p.getProperty("driver").split(";");
